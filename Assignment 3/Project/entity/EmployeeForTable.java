...
/**
 * The class EmployeeForTable represents a generic employee for table view
 * 
 * @author Eylon
 *	
 */
public class EmployeeForTable implements java.io.Serializable {
	...
	/**
	 * EmployeeForTable constructor with all fields as parameters
	 * 
	 ...
	 */
	public EmployeeForTable(String FirstName, String LastName, int EmployeeID, String Email, String Role,
	...
	/**
	 * EmployeeForTable constructor with all fields coming from the DB using
	 * ResultSet
	 * 
	 * @param resultSet Has all the employee's parameters
	 * @throws SQLException
	 */
	public EmployeeForTable(ResultSet resultSet) throws SQLException {
		...
		this.role = resultSet.getString(5);
		this.organizationalAffiliation = resultSet.getString(6);
		this.gasStation = resultSet.getString(7);
	}
